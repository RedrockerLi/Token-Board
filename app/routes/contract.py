...
ROUTE_CONTRACTS = {
    "dashboard_delete": RouteContract(
        ...
        response_shapes={
            "ok": ("status", "message", "archived_user_ids",
                   "not_found_user_ids", "archived_rows", "uploaded"),
            "invalid": ("status", "message"),
            "not_found": ("status", "message", "archived_user_ids",
                           "not_found_user_ids"),
            "conflict": ("status", "message"),
            "error": ("status", "message"),
        },
        messages={"invalid": "用户 ID 列表不能为空"}, json_mode="silent"),

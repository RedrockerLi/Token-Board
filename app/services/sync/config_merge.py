...
def merge_config_tables(remote_path: str, local_path: str) -> None:
    ...
    """
    with sqlite_runtime.connection(remote_path, "shadow_copy") as probe_remote, \
            sqlite_runtime.connection(local_path, "proxy_runtime") as probe_local:
...
def _merge_v2_config(remote_path: str, local_path: str) -> None:
    ...
    """
    with sqlite_runtime.connection(remote_path, "shadow_copy") as remote, \
            sqlite_runtime.connection(local_path, "proxy_runtime") as local:
        try:
